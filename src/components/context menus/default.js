...
function DefaultMenu(props) {
  ...
  return (
    ...
    >
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/akuldevali/portfolio/issues"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">❗</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="https://www.linkedin.com/in/akuldevali/"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
      ...
      <a
        rel="noreferrer noopener"
        href="https://github.com/akuldevali"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">🤝</span>{" "}
      ...
      <a
        rel="noreferrer noopener"
        href="mailto:akul.devali@gmail.com"
        target="_blank"
        className="w-full block cursor-default py-0.5 hover:bg-ub-warm-grey hover:bg-opacity-20 mb-1.5"
      >
        <span className="ml-5">📥</span>{" "}
